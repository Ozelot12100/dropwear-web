...
- ✅ **Fotos de prendas** — bucket Storage `product-images` + `products.image_url`.
- ✅ **Cliente en apartados** (nombre/contacto/vencimiento/anticipo) — apartados vencidos resaltados en Inventario y Dashboard.
- ✅ **Costo y margen** — `products.cost`; Catálogos captura costo y muestra margen; el Dashboard muestra "Utilidad Hoy" solo a roles financieros.
